...
import { Star, ShoppingCart, Heart, X, Filter, ChevronDown } from 'lucide-react';
...
const ProductList = () => {
  ...
  const {products,filters,categories, setFilters, isLoading} = useProducts();
  ...
  return (
    ...
    <div className="lg:hidden mb-4">
      ...
      >
        ...
        <ChevronDown className={`h-5 w-5 transform transition-transform duration-300 ${isMobileFiltersOpen ? 'rotate-180' : ''}`} />
      </button>
      {isMobileFiltersOpen && (
    ...
    <div className="grid grid-cols-1 lg:grid-cols-4 gap-8" key="product-list-container">
      {/* Filters Sidebar */}
            ...
            >
              ...
              <div className="p-4 flex-grow flex flex-col">
                ...
                <div className="mt-auto">
                  ...
                  className={`w-full flex items-center justify-center px-4 py-2 ${product.in_stock ? " bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors duration-300" : "border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-100 transition-colors duration-300"}`}
